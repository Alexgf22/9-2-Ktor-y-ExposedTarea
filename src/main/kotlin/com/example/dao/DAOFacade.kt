...
interface DAOFacade {
    ...
    suspend fun addNewArticle(title: String, body: String, sectionId: String): Article?
    suspend fun editArticle(id: Int, title: String, body: String, sectionId: String): Boolean
